    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="hamberger">
        ...
        <ul class="navbar-nav ms-auto">
          <a href="{{ route('login') }}"><button type="button" class="btn btn-outline-success me-2 my-1">เข้าสู่ระบบ</button></a>
          <a href="{{ route('register') }}"><button type="button" class="btn btn-success my-1">สมัครสมาชิก</button></a>
        </ul>
      </div>
    </div>
  </nav>
...
<section id="horo">
  ...
  <div class="container px-4">
    <h2 class="pb-2 border-bottom">ทำนายดวงชะตา</h2>
    <h3 class="px-5">ความรัก</h3>
    ...
    <h3 class="px-5">การเรียน</h3>
    <div class="row row-cols-1 row-cols-md-3 text-center pt-5 align-items-center d-flex justify-content-center">
      <div class="col" style="width: 12rem;">
        <div class="card mb-4 rounded-3 shadow-sm">
          <img src="{{ asset('source/images/2.png') }}" alt="" class="card-img-top">
          <div class="card-text">โดยรวม</div>
        </div>
      </div>
      <div class="col" style="width: 12rem;">
        <div class="card mb-4 rounded-3 shadow-sm">
          <img src="{{ asset('source/images/2.png') }}" alt="" class="card-img-top">
          <div class="card-text">คะแนน</div>
        </div>
      </div>
      <div class="col" style="width: 12rem;">
        <div class="card mb-4 rounded-3 shadow-sm">
          <img src="{{ asset('source/images/2.png') }}" alt="" class="card-img-top">
          <div class="card-text">สอบ</div>
        </div>
      </div>
      <div class="col" style="width: 12rem;">
        <div class="card mb-4 rounded-3 shadow-sm">
          <img src="{{ asset('source/images/2.png') }}" alt="" class="card-img-top">
          <div class="card-text">อุปสรรค</div>
        </div>
      </div>
    </div>
  </div>
